...
final class RDPTest extends TestCase
{
    ...
    public function testSimplifyLine1()
    {
        ...
        $line = array(
            new \IGCParser\TrackPoint(150, 10, 0),
            new \IGCParser\TrackPoint(200, 100, 0),
            new \IGCParser\TrackPoint(360, 170, 0),
            new \IGCParser\TrackPoint(500, 280, 0)
        );
        ...
        $result = \IGCParser\RDPLineSimplification::RDPLineSimplification($line, 30);
    ...
    {
        $line = array(
            new \IGCParser\TrackPoint(-30, -40,0),
            new \IGCParser\TrackPoint(-20, -10,0),
            new \IGCParser\TrackPoint(10, 10,0),
            new \IGCParser\TrackPoint(50, 0,0),
            new \IGCParser\TrackPoint(40, -30,0),
            new \IGCParser\TrackPoint(10, -40,0));
    ...
    {
        $line = array(
            new \IGCParser\TrackPoint(0.0034, 0.013,0),
            new \IGCParser\TrackPoint(0.0048, 0.006,0),
            new \IGCParser\TrackPoint(0.0062, 0.01,0),
            new \IGCParser\TrackPoint(0.0087, 0.009,0));
